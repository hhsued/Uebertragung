          ...
          q-expansion-item(
            ...
            q-card(style="margin: 10px")
              q-card-section
                Szenen(
                  Beschriftung="Szene",
                  v-model="Perspektiven[Perspektive].Szene"
                )
                .text-h6 Aktive Elemente
                Quellen(
                  Beschriftung="Kamera",
                  v-model="Perspektiven[Perspektive].aktiv.Kamera"
                )
                q-select(
                  label="Mikrofone",
              ...
              q-card-section
                ...
                Quellen(
                  Beschriftung="Kamera",
                  v-model="Perspektiven[Perspektive].inaktiv.Kamera"
                )
                q-select(
                  label="Mikrofone",
