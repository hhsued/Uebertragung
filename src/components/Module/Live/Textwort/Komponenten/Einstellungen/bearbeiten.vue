  ...
  .q-gutter-y-md
    q-card(style="min-width: 400px")
      ...
      q-card-section(v-if="bearbeiten")
        q-toolbar
          q-space
          q-btn(icon="close", unelevated, @click="on_Abbruch")
            ...
            q-list
              q-item(v-for="(Vers, VIndex) in Verse", :key="VIndex")
                ...
                q-item-section
                  ...
                  div(v-if="Vers[Object.keys(Vers)[0]].length > 78 && Vers[Object.keys(Vers)[0]].indexOf('<br />') === -1")
                    b(class="text-negative") Es könnte sein, dass dieser Vers nicht für die Anzeige optiemiert ist
</template>
<script>
