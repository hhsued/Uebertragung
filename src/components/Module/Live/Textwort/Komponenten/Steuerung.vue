 ...
 div
  .row
    .col
      q-card
        ...
        q-separator
        q-card-section
          Ausgabe(v-if="$store.state.Textwort.Buch !== null && $store.state.Textwort.Kapitel !== null && $store.state.Textwort.Vers_von !== null",
  ...
  .row
    .col
      q-card
        q-card-section
          .text-h6 Vorschau (noch nicht implementiert)
        q-card-section
          div Anzeige der Textstelle
</template>
