    ...
    template(v-slot:after)
      q-tab-panels(
        ...
        q-tab-panel(name="Steuerung")
          Steuerung(@zeige_Einstellungen="Registerkarten = 'Einstellungen'", @bearbeiten="on_bearbeiten($event)")
        q-tab-panel(name="Einstellungen")
          Einstellungen
        q-tab-panel(name="bearbeiten")
          bearbeiten(:externes_bearbeiten="externes_bearbeiten", @uebernommen="this.externes_bearbeiten.Status = false")
