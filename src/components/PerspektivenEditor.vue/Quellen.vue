...
q-select(
  ...
  template(v-slot:after)
    q-btn(round, dense, flat, icon="add", @click="on_neue_Quelle")
      q-tooltip Neue Quellen hier und in OBS hinzufügen
    q-btn(rout, dense, flat, icon="filter_alt")
      q-tooltip Filtern der vorhandenen quellen
</template>
<script>
