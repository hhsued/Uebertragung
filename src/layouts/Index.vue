...
q-layout(view="hHh LpR fFf")
    ...
    q-toolbar
      ...
      q-toolbar-title Übertragungen
        span(v-if="KeinOBSAktiv")
          | &nbsp;(Kein OBS aktiv)
          q-btn(icon="help", unelevated, @click="KeinOBSAktiv_Dialog = !KeinOBSAktiv_Dialog")
      ...
      div
        ...
        q-btn(icon="help", unelevated,  @click="on_Eintrag('Hilfe')")
  ...
  q-drawer(
    ...
    q-list(bordered, separator)
      ...
      q-item(clickable, v-ripple, @click="on_Eintrag('Hilfe'); Schublade_offen = false")
        q-item-section
...
export default {
  name: 'MainLayout',
  components: { Live, Einstellungen, KeinOBSAktiv, Einrichtung, keinOBSGefunden, Hilfe },
